...
export function registerHandle<Args extends unknown[], Return>(channel: string, handler: IpcHandler<Args, Return>): void {
...
export function registerOn<Args extends unknown[], Return>(channel: string, handler: IpcHandler<Args, Return>): void {
