...
export const settingsSchema = {
  General: {
    locale: {
      ...
      defaultValue: "en-US",
      description:
        'This is different from Discord\'s language. You can translate GoofCord <a target="_blank" href="https://hosted.weblate.org/projects/goofcord/goofcord/">here</a>.',
      inputType: "dropdown",
      options: allLangs,
    ...
    discordUrl: {
      ...
      description:
        'URL that GoofCord will load on launch. Add "canary." or "ptb." before "discord.com" for respective instances.',
      inputType: "textfield",
    },
    arrpc: {
    ...
    launchWithOsBoot: {
      ...
      defaultValue: false,
      description:
        "Start GoofCord automatically on system boot. May not work in some Linux environments.",
      inputType: "checkbox",
    ...
    spellcheckLanguages: {
      ...
      defaultValue: [],
      description:
        "A list of languages to check spelling for. When none are selected, the system default is used.",
  ...
  Appearance: {
    ...
    dynamicIcon: {
      ...
      defaultValue: true,
      description:
        "Shows pings/mentions count on GoofCord's icon and its tray. On Linux, pings on the taskbar only work when unitylib is installed.",
      inputType: "checkbox",
    },
    unreadBadge: {
      name: "Unread badge",
      defaultValue: false,
      description:
        "Shows if you have any unread messages on GoofCord's icon as a dot.",
      inputType: "checkbox",
      showAfter: {
        key: "dynamicIcon",
        condition: (value) => {
    ...
    customIconPath: {
      ...
      defaultValue: "",
      description:
        "Select an alternative icon for GoofCord to use. Images with transparency are recommended.",
      inputType: "file",
      accept: "image/*",
    },
    trayIcon: {
      ...
      description:
        "What tray icon to use. Symbolic attempts to mimic Gnome's monochromatic icons.",
      inputType: "dropdown",
    ...
    popoutWindowAlwaysOnTop: {
      ...
      defaultValue: true,
      description:
        "Makes voice chat pop out window always stay above other windows.",
      inputType: "checkbox",
    },
    transparency: {
      name: "Transparency",
      defaultValue: false,
      description:
        "Makes the window transparent for use with translucent themes.",
      inputType: "checkbox",
    },
  },
  "Client Mods": {
    ...
    customCssBundle: {
      ...
      defaultValue: "",
      description:
        "A raw link to the JS bundle and CSS bundle of a client mod you want to use.",
      inputType: "textfield",
      showAfter: {
        key: "modNames",
        condition: (value: string[]) => {
    ...
    invidiousEmbeds: {
      ...
      defaultValue: false,
      description:
        "Replaces YouTube embeds with Invidious embeds. You can customize the instance from Shelter's settings.",
      inputType: "checkbox",
    },
    messageEncryption: {
      ...
      defaultValue: false,
      description:
        'See <a target="_blank" href="https://github.com/Milkshiift/GoofCord/wiki/Message-Encryption">message encryption</a>.',
      inputType: "checkbox",
    },
    encryptionPasswords: {
      ...
      defaultValue: [],
      description:
        "Securely stored, encrypted list of passwords that will be used for encryption. A backup in a warm, safe place is recommended. Separate entries with commas.",
      inputType: "textarea",
      encrypted: true,
      showAfter: {
    ...
    encryptionCover: {
      ...
      defaultValue: "",
      description:
        "A message that a user without the password will see. At least two words or empty.",
      inputType: "textfield",
      showAfter: {
        key: "messageEncryption",
        condition: (value: boolean) => {
    ...
    encryptionMark: {
      ...
      defaultValue: "| ",
      description:
        "A string that will be prepended to each decrypted message so it's easier to know what messages are encrypted.",
      inputType: "textfield",
      showAfter: {
        key: "messageEncryption",
        condition: (value: boolean) => {
  ...
  Other: {
    domOptimizer: {
      ...
      defaultValue: true,
      description:
        "Defers DOM updates to possibly improve performance. May cause visual artifacts.",
      inputType: "checkbox",
    },
    renderingOptimizations: {
      ...
      defaultValue: true,
      description:
        "Applies CSS optimizations to improve scrolling smoothness. May cause text to become blurry if used with some themes.",
      inputType: "checkbox",
    },
    forceDedicatedGPU: {
    ...
    performanceFlags: {
      ...
      defaultValue: false,
      description:
        "Enables additional Chromium flags for performance. Recommended ON unless causes issues.",
      inputType: "checkbox",
    },
    ...
    blockedStrings: {
      ...
      description:
        "If any of specified strings are in the URL, it will be blocked.",
      inputType: "textarea",
      showAfter: {
        key: "customFirewallRules",
        condition: (value: boolean) => {
    ...
    allowedStrings: {
      ...
      description:
        "If any of specified strings are in the URL, it will *not* be blocked.",
      inputType: "textarea",
      showAfter: {
        key: "customFirewallRules",
        condition: (value: boolean) => {
    ...
    customUserAgent: {
      ...
      inputType: "textfield",
      description:
        "Changing may make your traffic suspicious. Leave empty for default.",
    },
    windowsSpoof: {
      ...
      inputType: "checkbox",
      description:
        "Tricks discord into thinking it is running on Windows (requires restart)",
    },
  ...
  Cloud: {
    ...
    cloudHost: {
      name: "Cloud Host",
      description:
        'GoofCord Cloud Server URL. You can self-host it yourself, see the <a target="_blank" href="https://github.com/Wuemeli/goofcord-cloudserver">repository</a>.',
    ...
    cloudEncryptionKey: {
      ...
      defaultValue: "",
      description:
        "Leave empty to not use encryption and not save message encryption passwords on cloud. You can't recover your password if you lose it.",
      inputType: "textfield",
      encrypted: true,
    },
